...
def run():
    ...
    capitals1 = yes_or_no_check("Do you want to include capitals? y/n  ", "Please say yes or no")
    #numbers1 = input("Do you want to include numbers? y/n  ")
    numbers1 = yes_or_no_check("Do you want to include numbers? y/n  ", "Placeholder")
    xtrachars1 = input("Do you want to include other characters? y/n  ")
    if "y" in xtrachars1:
        xtrachars = True
    else:
        xtrachars = False
    generated = generate(amount, capitals, numbers, xtrachars)
    return(generated)
